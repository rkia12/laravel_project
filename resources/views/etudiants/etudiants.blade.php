...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 mt-3 bg-white shadow rounded p-5 table-responsive">
            <h3 class="mb-3 fs-4">Liste des etudiants <a href="{{route("etudiant.add")}}" class="btn btn-secondary float-end">Ajouter</a></h3>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            responsive: true,
                ajax: "{{ route('etudiants') }}",
                columns: [
                    {data: 'id', name: 'id'},
                    {
                        "render": function (data, type, JsonResultRow, meta) {
                            return '<img src="/usersImages/'+JsonResultRow.photo+'" class="img-fluid rounded">';
                        }
                    },
                    {data: 'nom', name: 'nom'},
                    ...
                    {data: 'tel', name: 'tel'},
                    {data: 'date_u', name: 'date_u'},
                    {data: 'nomVille', name: 'nomVille'},
