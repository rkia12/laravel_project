...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 mt-3 bg-white shadow rounded p-5 table-responsive">
            <h3 class="mb-3 fs-4">Liste des matieres <a href="{{route("matiere.add")}}" class="btn btn-secondary float-end">Ajouter</a></h3>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            responsive: true,
                ...
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'nom_matiere', name: 'nom_matiere'},
                    {data: 'fichier_scol', name: 'fichier_scol'},
                    {data: 'nomClasse', name: 'nomClasse'},
