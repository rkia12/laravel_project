...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 mt-3 bg-white shadow rounded p-5 table-responsive">
            <h3 class="mb-3 fs-4">Liste des produits <a href="{{route("produit.add")}}" class="btn btn-secondary float-end">Ajouter</a></h3>
        ...
        $(function () {
            ...
            responsive: true,
                ...
                columns: [
                    ...
                    {data: 'nomCategorie', name: 'nomCategorie'},
                    {data: 'packType', name: 'packType'},
